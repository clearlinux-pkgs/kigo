...
Source0  : https://download.kde.org/stable/release-service/21.12.2/src/kigo-21.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.2/src/kigo-21.12.2.tar.xz.sig
...
%prep
%setup -q -n kigo-21.12.2
cd %{_builddir}/kigo-21.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644019237
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kigo-21.12.2/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kigo/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kigo-21.12.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kigo/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kigo-21.12.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kigo/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/kigo-21.12.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kigo/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kigo-21.12.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kigo/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
