...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/kigo-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/kigo-24.12.0.tar.xz.sig
...
%setup -q -n kigo-24.12.0
cd %{_builddir}/kigo-24.12.0
pushd ..
cp -a kigo-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735229138
mkdir -p clr-build
pushd clr-build
...
/usr/share/qlogging-categories6/kigo.renamecategories
...
/usr/share/doc/HTML/sl/kigo/index.cache.bz2
/usr/share/doc/HTML/sl/kigo/index.docbook
