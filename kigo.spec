...
Source0  : https://download.kde.org/stable/release-service/19.12.0/src/kigo-19.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.0/src/kigo-19.12.0.tar.xz.sig
...
%prep
%setup -q -n kigo-19.12.0
cd %{_builddir}/kigo-19.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576555266
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kigo-19.12.0/COPYING %{buildroot}/usr/share/package-licenses/kigo/fafaf6b2753f82aa8df1d206d6b76c2241c2dfa8
cp %{_builddir}/kigo-19.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/kigo/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang kigo
