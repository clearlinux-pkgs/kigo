...
Requires: kigo-bin
Requires: kigo-data
Requires: kigo-license
Requires: kigo-locales
...
cp COPYING.DOC %{buildroot}/usr/share/doc/kigo/COPYING.DOC
pushd clr-build
%make_install
popd
%find_lang kigo
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/kigo/COPYING
/usr/share/doc/kigo/COPYING.DOC
