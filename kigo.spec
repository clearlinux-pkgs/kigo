...
Version  : 22.04.1
Release  : 40
URL      : https://download.kde.org/stable/release-service/22.04.1/src/kigo-22.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.1/src/kigo-22.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.1/src/kigo-22.04.1.tar.xz.sig
...
%prep
%setup -q -n kigo-22.04.1
cd %{_builddir}/kigo-22.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652651768
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kigo-22.04.1/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kigo/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kigo-22.04.1/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kigo/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kigo-22.04.1/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kigo/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kigo-22.04.1/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kigo/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kigo-22.04.1/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kigo/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kigo-22.04.1/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kigo/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/kigo-22.04.1/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kigo/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kigo-22.04.1/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kigo/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
