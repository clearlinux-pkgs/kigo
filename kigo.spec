...
Source0  : https://download.kde.org/stable/release-service/20.12.1/src/kigo-20.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.1/src/kigo-20.12.1.tar.xz.sig
...
%prep
%setup -q -n kigo-20.12.1
cd %{_builddir}/kigo-20.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610048735
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kigo-20.12.1/COPYING %{buildroot}/usr/share/package-licenses/kigo/fafaf6b2753f82aa8df1d206d6b76c2241c2dfa8
cp %{_builddir}/kigo-20.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kigo/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang kigo
