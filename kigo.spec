...
Source0  : https://download.kde.org/stable/release-service/20.08.2/src/kigo-20.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.2/src/kigo-20.08.2.tar.xz.sig
...
%prep
%setup -q -n kigo-20.08.2
cd %{_builddir}/kigo-20.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602708644
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kigo-20.08.2/COPYING %{buildroot}/usr/share/package-licenses/kigo/fafaf6b2753f82aa8df1d206d6b76c2241c2dfa8
cp %{_builddir}/kigo-20.08.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/kigo/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang kigo
